...
root.routes = (socket) ->
  ...
  attachSingleEvent: ->
    ...
    $InputImage.change                 (e) -> DomEvent.requestUploadImage e
    ...
    $InputDesc.keyup                       -> DomEvent.requestChangeDesc()
    ...
    $ApplyEditFeed.click                   -> FeedEvent.requestEditFeedList this,socket
    socket.on 'edit completed',            -> FeedEvent.receivedEditFeedList socket

    $AddFeedButton.click                   -> FeedEvent.requestAddFeed()
