...
module.exports = (app) ->
  ...
  app.post '/:stream/subscribe',  (req,res,next)-> StreamEvent.subscribe req,res,next
  app.post '/:stream/unsubscribe',(req,res,next)-> StreamEvent.unsubscribe req,res,next
